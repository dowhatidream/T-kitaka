...
public class AdQSystemListFragment extends Fragment{
    ...
    AdQSystemListFragment.AdQSystemListAdapter adQSystemListAdapter;
    List<Question> adQSystemList;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.fragment_ad_qsystem_list, container, false );
        ...
        adQSystemListAdapter = new AdQSystemListAdapter(getContext(), questionList);
        ...
        rvQue.setAdapter(adQSystemListAdapter);

        adQSystemList = new ArrayList<>(  );
        adQSystemListAdapter = new AdQSystemListAdapter(getContext(), adQSystemList);

        adQSystemListAdapter.setOnItemClickListener(new AdQSystemListAdapter.OnItemClickListener() {
    ...
    void  getFIrebaseData(){
        reference = database.getReference("Question").child("시스템 불편사항");
        reference.addChildEventListener( new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                Question question = dataSnapshot.getValue(Question.class);
                adQSystemList.add( 0, question );
                rvQue.setAdapter(adQSystemListAdapter);
            }
    ...
    private void updateAnswer(int position){
        question = adQSystemList.get( position );
    ...
    public static class AdQSystemListAdapter extends RecyclerView.Adapter<AdQSystemListAdapter.ViewHolder>{
        ...
        public AdQSystemListAdapter(OnItemClickListener listener) {
            this.mListener = listener;
        }

        List<Question> listArray;

        public AdQSystemListAdapter(Context context, List<Question> list){
            this.listArray = list;
        ...
        @NonNull
        @Override
        public AdQSystemListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int position) {
        ...
        @Override
        public void onBindViewHolder(@NonNull final AdQSystemListAdapter.ViewHolder holder, int position) {
